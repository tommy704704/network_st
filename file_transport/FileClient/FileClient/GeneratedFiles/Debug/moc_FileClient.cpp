...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FileClient_t, stringdata) + ofs \
...
const QMetaObject FileClient::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FileClient.data,
      qt_meta_data_FileClient,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FileClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FileClient.stringdata))
        return static_cast<void*>(const_cast< FileClient*>(this));
