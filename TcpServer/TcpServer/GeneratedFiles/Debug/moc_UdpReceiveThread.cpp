...
void network_st::UdpReceiveThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Signal_UpdateAddressList((*reinterpret_cast< Client*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (UdpReceiveThread::*_t)(Client * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpReceiveThread::Signal_UpdateAddressList)) {
                *result = 0;
                return;
            }
        }
