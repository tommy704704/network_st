...
void network_st::TcpReceiveThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpReceiveThread::Signal_UpdateUITcpReceivedMessage)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (TcpReceiveThread::*_t)(MessageUnit * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpReceiveThread::Signal_SendMessage)) {
                *result = 1;
                return;
            }
        }
