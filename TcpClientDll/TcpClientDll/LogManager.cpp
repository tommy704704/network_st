...
network_client_st::LogManager::LogManager()
{
	Init();
}
...
void network_client_st::LogManager::AppendLog(QString _logMessage)
{
	mutex_.lock();
...
void network_client_st::LogManager::OutLog()
{
	mutex_.lock();
...
void network_client_st::LogManager::CreatSignalAndSlot()
{
}

void network_client_st::LogManager::Init()
{
