...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_network_st__NetInterface_t, stringdata) + ofs \
...
void network_st::NetInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetInterface::Signal_UpdateUITcpReplyMessage)) {
                *result = 0;
            }
        }
        {
            typedef void (NetInterface::*_t)(MessageUnit * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetInterface::Signal_UpdateUITcpReceivedMessage)) {
                *result = 1;
            }
        }
        {
            typedef void (NetInterface::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetInterface::Signal_GetServerAddress)) {
                *result = 2;
            }
        }
        {
            typedef void (NetInterface::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetInterface::Signal_AddReceivedMessage)) {
                *result = 3;
            }
        }
        {
            typedef void (NetInterface::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetInterface::Signal_BindNewTcpConnection)) {
                *result = 4;
            }
        }
    }
...
const QMetaObject network_st::NetInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_network_st__NetInterface.data,
      qt_meta_data_network_st__NetInterface,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *network_st::NetInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_network_st__NetInterface.stringdata))
