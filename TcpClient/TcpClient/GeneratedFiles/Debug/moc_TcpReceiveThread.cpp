...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_network_st__TcpReceiveThread_t, stringdata) + ofs \
...
void network_st::TcpReceiveThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->Signal_SendMessage((*reinterpret_cast< MessageUnit*(*)>(_a[1]))); break;
        case 2: _t->Slot_ReadMessage(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpReceiveThread::Signal_UpdateUITcpReceivedMessage)) {
                *result = 0;
            }
        }
        {
            typedef void (TcpReceiveThread::*_t)(MessageUnit * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpReceiveThread::Signal_SendMessage)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject network_st::TcpReceiveThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_network_st__TcpReceiveThread.data,
      qt_meta_data_network_st__TcpReceiveThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *network_st::TcpReceiveThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_network_st__TcpReceiveThread.stringdata))
        return static_cast<void*>(const_cast< TcpReceiveThread*>(this));
