...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_network_st__TcpSendThread_t, stringdata) + ofs \
...
void network_st::TcpSendThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpSendThread::Signal_SendMessage)) {
                *result = 0;
            }
        }
        {
            typedef void (TcpSendThread::*_t)(MessageUnit * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TcpSendThread::Signal_UpdateUITcpReplyMessage)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject network_st::TcpSendThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_network_st__TcpSendThread.data,
      qt_meta_data_network_st__TcpSendThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *network_st::TcpSendThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_network_st__TcpSendThread.stringdata))
        return static_cast<void*>(const_cast< TcpSendThread*>(this));
